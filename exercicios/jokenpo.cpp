...
int main()
{
       ...
       escolha_do_jogador_2 == "tesoura"))
  {
    ...
    if (escolha_do_jogador_1 == "pedra" && escolha_do_jogador_2 == "tesoura")
    {
      cout << "jogador 1 ganhou!";
    }
    else if (escolha_do_jogador_1 == "tesoura" && escolha_do_jogador_2 == "papel")
    {
      cout << "jogador 1 ganhou!";
    }
    else if (escolha_do_jogador_1 == "papel" && escolha_do_jogador_2 == "pedra")
    {
      cout << "jogador 1 ganhou!";
    }
    else if (escolha_do_jogador_1 == "pedra" && escolha_do_jogador_2 == "papel")
    {
      cout << "jogador 2 ganhou!";
    }
    else if (escolha_do_jogador_1 == "tesoura" && escolha_do_jogador_2 == "pedra")
    {
      cout << "jogador 2 ganhou!";
    }
    else if (escolha_do_jogador_1 == "papel" && escolha_do_jogador_2 == "tesoura")
    {
      cout << "jogador 2 ganhou!";
    }
    else
